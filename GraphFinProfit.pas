...
uses
  ...
  TeEngine, Series, ExtCtrls, TeeProcs, Chart, dxBar, cxClasses, DB, ADODB,
  Printers;

type
  TFinGraphForm = class(TFrame)
...
procedure TFinGraphForm.dxBarButton1Click(Sender: TObject);
var PD:TPrintDialog;
begin
...
procedure TFinGraphForm.ShowGraph;
var
  i: Integer;
    ...
    begin
     if ChartQRYear.AsInteger = year-2 then
      ...
      if ChartQRYear.AsInteger = year-1 then
          Series4.AddXY(ChartQRMonth.AsInteger,ChartQRSumProfit.AsFloat,
                                  LongMonthNames[ChartQRMonth.AsInteger]);
      if ChartQRYear.AsInteger = year then
          Series1.AddXY(ChartQRMonth.AsInteger,ChartQRSumProfit.AsFloat,
                                  LongMonthNames[ChartQRMonth.AsInteger]);
      ChartQR.Next;
    end;
