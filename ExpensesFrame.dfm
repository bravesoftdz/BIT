object ExpFrame: TExpFrame
  ...
  object cxGrid1: TcxGrid
    ...
    object ExpView: TcxGridDBTableView
      NavigatorButtons.ConfirmDelete = False
      FilterBox.Visible = fvNever
      DataController.DataSource = MainDM.ExpDS
      DataController.Summary.DefaultGroupSummaryItems = <>
      DataController.Summary.FooterSummaryItems = <
        item
          Kind = skSum
          FieldName = 'ExpenseValue'
          Column = ExpViewExpenseValue
        end>
      ...
      object ExpViewID: TcxGridDBColumn
        DataBinding.FieldName = 'ID'
        Visible = False
      end
      object ExpViewExpenseDate: TcxGridDBColumn
        DataBinding.FieldName = 'ExpenseDate'
        Width = 122
      end
      object ExpViewExpenseName: TcxGridDBColumn
        DataBinding.FieldName = 'ExpenseName'
        Width = 164
      end
      object ExpViewExpenseValue: TcxGridDBColumn
        DataBinding.FieldName = 'ExpenseValue'
        Width = 97
      end
      object ExpViewClearProfitException: TcxGridDBColumn
