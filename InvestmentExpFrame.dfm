object InvestExpFrame: TInvestExpFrame
  Left = 0
  Top = 0
  Width = 440
  Height = 423
  ...
  object cxGrid1: TcxGrid
    ...
    object InvExpView: TcxGridDBTableView
      NavigatorButtons.ConfirmDelete = False
      FilterBox.Visible = fvNever
      DataController.DataSource = MainDM.InvExpDS
      DataController.Summary.DefaultGroupSummaryItems = <>
      DataController.Summary.FooterSummaryItems = <
        item
          Kind = skSum
          FieldName = 'InvExpValue'
          Column = InvExpViewInvExpValue
        end>
      ...
      object InvExpViewid: TcxGridDBColumn
        DataBinding.FieldName = 'id'
        Visible = False
      end
      object InvExpViewInvExpDate: TcxGridDBColumn
        DataBinding.FieldName = 'InvExpDate'
        Width = 90
      end
      object InvExpViewInvExpName: TcxGridDBColumn
        DataBinding.FieldName = 'InvExpName'
        Width = 159
      end
      object InvExpViewInvExpValue: TcxGridDBColumn
        DataBinding.FieldName = 'InvExpValue'
        Width = 87
      end
      object InvExpViewClearProfitException: TcxGridDBColumn
