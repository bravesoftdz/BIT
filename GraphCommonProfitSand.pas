...
type
  TCommonProfitGraphFormSand = class(TFrame)
...
procedure TCommonProfitGraphFormSand.dxBarButton1Click(Sender: TObject);
var PD:TPrintDialog;
begin
...
procedure TCommonProfitGraphFormSand.ShowGraph;
var i:integer;
